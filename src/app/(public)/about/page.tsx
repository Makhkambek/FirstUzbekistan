...
const values = [
    {
        title: "Развитие робототехники",
        description: "Строим первую экосистему программ FIRST в Узбекистане и делаем робототехнику доступной для всех.",
        icon: Rocket,
    },
    {
        title: "Образование и наставничество",
        description: "Обучаем инженерии, программированию и создаем образовательные материалы на русском языке.",
        icon: Target,
    },
    {
        title: "Сообщество и поддержка",
        description: "Помогаем командам по всей стране, делимся опытом и растём вместе.",
        icon: Users,
    },
];
                    ...
                    <Card className="border-2">
                        <CardContent className="p-8 text-center">
                            <p className="text-lg leading-relaxed">
                                Наша миссия — <strong className="text-ftc-red">развивать робототехническое образование в Узбекистане</strong> через
                                программы FIRST. Мы создаём платформу для молодёжи, где они могут изучать инженерию и программирование,
                                участвовать в международных соревнованиях и становиться частью глобального сообщества инноваторов.
                                Мы строим <strong className="text-ftc-blue">экосистему поддержки команд</strong>, создаём образовательные ресурсы
                                и вдохновляем следующее поколение узбекских инженеров и лидеров.
                            </p>
                        </CardContent>
                    </Card>
                </div>
