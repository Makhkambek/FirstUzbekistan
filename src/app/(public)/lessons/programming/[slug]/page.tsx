...
export default function ProgrammingLessonPage({ params }: PageProps) {
    ...
    useEffect(() => {
        async function fetchData() {
            ...
            if (!lessonData || lessonData.category !== "programming") {
                notFound();
            }
            ...
            <Section className="py-6 border-b border-border">
                <Container>
                    <div className="flex items-center gap-2 text-sm text-muted-foreground">
                        ...
                        <Link href="/lessons/programming" className="hover:text-foreground">
                            Программирование
                        </Link>
                        <ChevronRight className="h-4 w-4" />
                            ...
                            >
                                ...
                                <div className="mt-6">
                                    <div className="flex flex-wrap gap-2 mb-3">
                                        <Badge variant="programming">Программирование</Badge>
                                    ...
                                    <CardContent className="p-6">
                                        ...
                                        <div className="space-y-3">
                                            <Button asChild variant="outline" className="w-full justify-start">
                                                <Link href="/lessons/programming">
                                                    <ArrowLeft className="mr-2 h-4 w-4" />
                                                    Все уроки программирования
                                                </Link>
                                            </Button>
                                            <Button asChild variant="outline" className="w-full justify-start">
                                                <a
                                        ...
                                        <CardContent className="p-6">
                                            ...
                                            <div className="space-y-3">
                                                {relatedLessons.map((related) => (
                                                    <Link
                                                        key={related.id}
                                                        href={`/lessons/programming/${related.slug}`}
                                                    ...
                                                    >
                                                        <div className="flex gap-3 p-3 rounded-lg hover:bg-accent transition-colors">
                                                            <div className="relative h-16 w-24 shrink-0 overflow-hidden rounded bg-muted">
                                                                <div className="flex h-full w-full items-center justify-center bg-gradient-to-br from-programming-500/20 to-programming-600/20">
                                                                    <PlayCircle className="h-6 w-6 text-muted-foreground/50" />
                                                                </div>
                                                            </div>
                                                            <div className="flex-1 min-w-0">
                                                                <p className="font-medium text-sm line-clamp-2 group-hover:text-programming-500 transition-colors">
                                                                    {related.title}
                                                                </p>
